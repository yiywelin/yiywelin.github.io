...
const YOUTUBE_API_KEY = config.YOUTUBE_API_KEY; // Use the imported API key

// When the webpage loads
// Display all heroes
window.display_default = function() { // Assign to window object
...
window.call_youtube_api = function(hero_name) {
